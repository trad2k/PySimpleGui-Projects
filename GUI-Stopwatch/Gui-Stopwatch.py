...
def create_window():
    ...
    layout = [
        [sg.Push(),
        sg.Image('close.png', enable_events=True, key='-CLOSE-')],
        [sg.VPush()],
        [sg.Text('0.0', font='Arial 50', key='-TIME-')],
        [sg.Button('Start', button_color=('#FFFFFF', '#FF0000'), border_width=0, key='-STARTSTOP-'),
        sg.Button('Lap', button_color=('#FFFFFF','#999999'), border_width=0, key='-LAP-', visible=False)],
        [sg.VPush()],
        [sg.Column([[]], key='-LAPS-')],
